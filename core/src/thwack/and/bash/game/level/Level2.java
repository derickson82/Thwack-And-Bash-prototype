...
//		if (i == 0) {
//			rect = new Rectangle(Pixels.toMeters(view.x + view.width / 2 + currentChunk.x * Values.CHUNK_SIZE_X),
//				Pixels.toMeters(view.y + view.height + currentChunk.y * Values.CHUNK_SIZE_Y), Pixels.toMeters(view.width),
//				Pixels.toMeters(1));
//		} else if (i == 1) {
//			rect = new Rectangle(Pixels.toMeters(view.x + view.width + currentChunk.x * Values.CHUNK_SIZE_X), Pixels.toMeters(view.y
//				+ view.height / 2 + currentChunk.y * Values.CHUNK_SIZE_Y), Pixels.toMeters(1), Pixels.toMeters(view.height));
//		} else if (i == 2) {
//			rect = new Rectangle(Pixels.toMeters(view.x + view.width / 2 + currentChunk.x * Values.CHUNK_SIZE_X),
//				Pixels.toMeters(view.y + currentChunk.y * Values.CHUNK_SIZE_Y), Pixels.toMeters(view.width), Pixels.toMeters(1));
//		} else if (i == 3) {
//			rect = new Rectangle(Pixels.toMeters(view.x + currentChunk.x * Values.CHUNK_SIZE_X), Pixels.toMeters(view.y
//				+ view.height / 2 + currentChunk.y * Values.CHUNK_SIZE_Y), Pixels.toMeters(1), Pixels.toMeters(view.height));
//		}
//		return rect;
//	}
...
//					TiledMapTileLayer newLayer = new TiledMapTileLayer((int)Values.CHUNK_SIZE_X, (int)Values.CHUNK_SIZE_Y,
//						(int)firstLayer.getTileWidth(), (int)firstLayer.getTileHeight());
//					for (int xTile = 0; xTile < Values.CHUNK_SIZE_X; xTile++) {
//						for (int yTile = 0; yTile < Values.CHUNK_SIZE_Y; yTile++) {
//							newLayer.setCell(
//								xTile,
//								yTile,
//								wholeMapLayer.getCell((int)(xTile + xChunk * Values.CHUNK_SIZE_X), (int)(yTile + yChunk
//									* Values.CHUNK_SIZE_Y)));
//						}
//					}
...
//		} else if (c.x < 0) {
//			player.setX((Pixels.toMeters(Game.getMapViewport().x + Game.getMapViewport().width
//				- (player.getSprite().getWidth() + -scale))));
//		} else if (c.y < 0) {
//			player.setY(Pixels.toMeters(Game.getMapViewport().y + Game.getMapViewport().height
//				- (player.getSprite().getHeight() + -scale)));
//		}
//	}
}
