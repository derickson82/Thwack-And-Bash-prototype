...
public class MainMenuScreen implements GameScreen {
	...
	public void show () {
		...
		TextButton play = new TextButton("Play", Objects.BLUE_TEXT_BUTTON_STYLE);
		TextButton options = new TextButton("Options", Objects.BLUE_TEXT_BUTTON_STYLE);
		TextButton exit = new TextButton("Exit", Objects.BLUE_TEXT_BUTTON_STYLE);
