...
public class PlayScreen implements GameScreen{
	...
	public void update(float delta) {
		...
		Game.getScreenCamera().position.set(Meters.toPixels(player.getX()), Meters.toPixels(player.getY()), 0);
	}
	...
	public void render(SpriteBatch batch) {
		...
		box2DRenderer.render(world, Game.getScreenCamera().combined.scl(Util.PIXELS_PER_METER));
	}
