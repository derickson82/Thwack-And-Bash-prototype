 ...
 * 
 * This version has been modified to work with the new JsonReader implementation that uses
 * JsonValue objects instead of OrderedMaps. This was also necessary for GWT to compile
 * correctly.
 * 
 * Modified by Dan Erickson (derickson82)
 */
